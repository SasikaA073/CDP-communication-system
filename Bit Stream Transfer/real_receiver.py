...
import sip
import transmitter_epy_block_5 as epy_block_5  # embedded python block
...
class transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.blocks_file_sink_0_1_0 = blocks.file_sink(gr.sizeof_char*1, '/home/thisara/Documents/old-cdp-docs/Bit Stream Transfer/output.txt', False)
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.epy_block_5, 0))
