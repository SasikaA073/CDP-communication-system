...
class transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default', MTU=1500, frame_size=30, puncpat='11'):
        ...
        self.enc_rep = enc_rep = fec.repetition_encoder_make(12000, 3)
        self.enc_dummy = enc_dummy = fec.dummy_encoder_make((frame_size*8))
        self.dec_rep = dec_rep = fec.repetition_decoder.make(12000,3, 0.5)
        ...
        self.fec_extended_tagged_encoder_0_1 = fec.extended_tagged_encoder(encoder_obj_list=enc_rep, puncpat='11', lentagname="packet_len", mtu=MTU)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.digital_crc32_bb_0_1, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.digital_gfsk_mod_0, 0))
        self.connect((self.digital_crc32_bb_0_1, 0), (self.blocks_repack_bits_bb_0_0, 0))
...
def main(top_block_cls=transmitter, options=None):
    ...
    tb = top_block_cls(InFile=options.InFile, MTU=options.MTU, frame_size=options.frame_size)
