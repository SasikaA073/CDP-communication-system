...
import pkt_fsk_xmt_epy_block_4 as epy_block_4  # embedded python block
import pkt_fsk_xmt_epy_block_5 as epy_block_5  # embedded python block
import sip
...
class pkt_fsk_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.connect((self.digital_crc32_bb_0_0, 0), (self.epy_block_5, 0))
        self.connect((self.digital_protocol_formatter_bb_0, 0), (self.blocks_tagged_stream_mux_0, 0))
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.digital_binary_slicer_fb_0, 0))
        self.connect((self.epy_block_0, 0), (self.epy_block_4, 0))
